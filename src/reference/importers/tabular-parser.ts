...
function csvRecords(input: string, delimiter: string): readonly ParsedTabularRecord[] {
...
function jsonRecords(input: string): readonly ParsedTabularRecord[] {
...
export function parseTabularRecords(
  ...
  return format === "csv" ? csvRecords(input, csvDelimiter) : jsonRecords(input);
}
