...
from validate_activation_review_decisions import SECOND_REVIEW_SLICE

DEFAULT_OUTPUT_REPORT = ROOT / "data/grammar/naer-reviewed-catalog-activation-2-report.json"

BATCH = BatchIdentity(
    slug="v2",
    order_range_label="orders 26–50",
    review_slice=SECOND_REVIEW_SLICE,
    previous_report_path=ROOT / "data/grammar/naer-reviewed-catalog-activation-1-report.json",
)
