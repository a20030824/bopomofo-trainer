...
DEFAULT_DECISIONS = (
    ROOT / "data/grammar/naer-activation-review-batch-1-decisions-51-100.csv"
)
...
DEFAULT_OUTPUT_REPORT = (
    ROOT / "data/grammar/naer-reviewed-catalog-activation-3-report.json"
)

ADAPTER_VERSION = "naer-reviewed-catalog-activation-v3"
ACTIVATION_PROVENANCE_ID = "local:activation-review-v3"
ACTIVATION_PROVENANCE_ROW = {
    "id": ACTIVATION_PROVENANCE_ID,
    "kind": "manual",
    "title": "Bopomofo Trainer NAER activation review v3",
    "license": "not-applicable",
    "notes": (
        "Reviewed rank-ordered catalog activation decisions for batch orders 51–100; "
        "preserves committed reading and grammar evidence and excludes held candidates."
    ),
}

BASELINE_ACTIVE_COUNT = 80
TARGET_ACTIVE_COUNT = 114
...
def load_review_decisions(
    ...
    validation = validate_third_files(batch_path, decision_report_path, decisions_path)
        ...
        **report_core,
        ...
        "policy": {
            ...
            "grammarDecisionSource": (
                "data/grammar/naer-activation-review-batch-1-decisions-51-100.csv"
            ),
