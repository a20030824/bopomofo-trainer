...
const allEntries = [...partition.practice, ...partition.evaluation];
const encodedProfiles = encodeSyntaxProfiles(syntaxProfiles, allEntries);
const moduleSource = [
  ...
  "",
  `const ENCODED_PRACTICE: readonly EncodedCatalogEntry[] = ${JSON.stringify(encodeCatalogEntries(partition.practice))};`,
  `const ENCODED_EVALUATION: readonly EncodedCatalogEntry[] = ${JSON.stringify(encodeCatalogEntries(partition.evaluation))};`,
  ...
  "  [...PRACTICE_CATALOG, ...EVALUATION_CATALOG],",
